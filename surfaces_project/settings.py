"""
Django settings for surfaces_project project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-l^am#w%gm6k(@6aw(a517ity&u^b6mz%4p5u)+c=6eklhg30yu')
...
INSTALLED_APPS = [
    ...
    'surface_play.apps.SurfacePlayConfig'
]
...
WSGI_APPLICATION = 'surfaces_project.wsgi.application'
...
SESSION_SERIALIZER = 'django.contrib.sessions.serializers.PickleSerializer' # pour pouvoir serialiser une surface.
...
# Make sure this matches your local folder name (e.g., 'static')
# STATICFILES_DIRS = [
#    os.path.join(BASE_DIR, 'static'),
#]
